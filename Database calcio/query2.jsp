...
<%
    ...
    String colonne[][] = {
        { "id", "nome", "cognome", "ruolo", "squadra", "eta", "nazionalita" },
        { "#", "Nome", "Cognome", "Ruolo", "Squadra", "Et&agrave;", "Nazionalit&agrave;" }
    };
    ...
    try {
        ...
        squadra = request.getParameter("squadra");
    } catch(Exception e) {
        //Errore !
    }
    ...
    if(ruolo != null && squadra != null) {
        query = "select A.id, A.nome, A.cognome, A.ruolo, C.nome squadra, A.eta, A.nazionalita from calciatori A join carriere B on A.id = B.idCalciatore join squadre C on B.idSquadra = C.id where A.ruolo like '" + ruolo + "' and C.nome like '" + squadra + "';";
    } else {
        query = "select A.id, A.nome, A.cognome, A.ruolo, C.nome squadra, A.eta, A.nazionalita from calciatori A join carriere B on A.id = B.idCalciatore join squadre C on B.idSquadra = C.id";
    }
%>
<html>
    <head>
    ...
    <body>
        <div class="container main-content">
            <div class="row justify-content-center">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Giocatori dato ruolo e squadra</h3>
                        <h6 class="card-subtitle mb-2 text-muted">Dato ruolo e squadra mostra chi ha giocato in quel ruolo e in quella squadra</h6>
                        <form action="query2.jsp" method="GET" class="zero-margin-bottom">
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <div class="input-group-text" style="width: 100px">Squadra</div>
                                </div>
                                <% mostraOpzioni(out, querySquadre, "squadra", "Seleziona una squadra", squadra); %>
                            </div>
                            <div class="container">
                                <div class="row">
